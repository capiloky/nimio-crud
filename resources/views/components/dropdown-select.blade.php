<div class="relative mt-1" x-data="{ open: false }" @click.away="open = false" @close.stop="open = false" >
    ...
    class="absolute mt-1 w-full bg-white shadow-lg max-h-56 rounded-md py-1 text-base ring-1 ring-black ring-opacity-5 overflow-auto focus:outline-none sm:text-sm z-10" 
